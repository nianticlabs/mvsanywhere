...
CHECKPOINT='/mnt/nas/personal/mohameds/geometry_hints/weights/hero_model_sampled_weights/version_0/checkpoints/epoch=7-step=87498.ckpt'
CONFIG='/mnt/nas/personal/mohameds/geometry_hints/weights/hero_model_sampled_weights/version_0/config.yaml'
...
--name hero_model_sampled_weights_no_hint;
...
--depth_hint_aug 0.0 \
--depth_hint_dir /mnt/nas3/personal/mohameds/geometry_hints/outputs/hero_model_fast/scannet/default/meshes/0.04_3.0_ours/renders/  \
--name hero_model_sampled_weights_with_hint;
...
--depth_hint_aug 0.0 \
--depth_hint_dir /mnt/nas3/personal/mohameds/geometry_hints/outputs/hero_model_fast/scannet/default/meshes/0.04_3.0_ours/renders/  \
--name hero_model_sampled_weights_with_hint_null \
--null_plane_sweep;
...
--dataset_path /mnt/scannet  \
--depth_hint_aug 0.0  \
--name hero_model_sampled_weights_incremental \
--run_fusion \
