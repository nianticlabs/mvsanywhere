...
CHECKPOINT='/mnt/nas/personal/mohameds/geometry_hints/weights/hero_model_mesh_hint_sep_mlp/version_0/checkpoints/epoch=8-step=87759.ckpt'
CONFIG='/mnt/nas/personal/mohameds/geometry_hints/weights/hero_model_mesh_hint_sep_mlp/version_0/config.yaml'
...
--depth_hint_dir /mnt/nas3/personal/mohameds/geometry_hints/outputs/hero_model_fast/scannet/default/meshes/0.04_3.0_ours/renders/  \
--run_fusion \
--name full_SR_sep_mlp_with_hint;
...
--depth_hint_dir /mnt/nas3/personal/mohameds/geometry_hints/outputs/hero_model_fast/scannet/default/meshes/0.04_3.0_ours/renders/  \
--run_fusion \
--name full_SR_with_hint_no_plane_sweep \
--null_plane_sweep;
...
# --dataset_path /mnt/scannet  \
# --depth_hint_aug 0.0  \
# --name full_SR_sep_mlp_with_incremental_hint_threshold \
# --run_fusion \
