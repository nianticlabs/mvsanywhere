...
from geometryhints.utils.geometry_utils import qvec2rotmat, rotx
...
class ColmapDataset(GenericMVSDataset):
    ...
    def load_intrinsics(self, scan_id, frame_id=None, flip=None):
        ...
        scene_path = os.path.join(
            self.dataset_path, self.get_sub_folder_dir(self.split), scan_id, "undistorted", "sparse"
        )
    ...
    def get_color_filepath(self, scan_id, frame_id):
        ...
        color_path = os.path.join(scene_path, "images_low_res", f"{frame_id}.JPG")
