...
class BlendedMVGDataset(GenericMVSDataset):
    """
    BLendedMVG DTU Dataset class.
    ...
    def get_high_res_color_filepath(self, scan_id, frame_id):
        ...
        return os.path.join(self.scenes_path, scan_id, "blended_images", f"{frame_id}.jpg")
    ...
    def get_full_res_depth_filepath(self, scan_id, frame_id):
        ...
        return os.path.join(self.scenes_path, scan_id, "rendered_depth_maps", f"{frame_id}.pfm")
    ...
    def get_pose_filepath(self, scan_id, frame_id):
        ...
        """
        return os.path.join(self.scenes_path, scan_id, "cams", f"{frame_id}_cam.txt")
    ...
    def load_intrinsics(self, scan_id, frame_id=None, flip=False):
        ...
        output_dict["min_depth"] = torch.tensor(float(lines[11].split()[0]))
        output_dict["max_depth"] = torch.tensor(float(lines[11].split()[3]))
    ...
    def load_full_res_depth_and_mask(self, scan_id, frame_id):
        ...
        # Load depth
        full_res_depth = read_pfm_file(full_res_depth_filepath, value_scale_factor=1)
