...
class CustomColorJitterNoise(torch.nn.Module):
    """Custom Jitter module"""
    ...
    def __init__(
        ...
        self.transform = torch.nn.Sequential(
            ...
            kornia.augmentation.RandomGaussianBlur((3, 3), (0.1, 2.0), p=0.1, keepdim=True),
            kornia.augmentation.RandomGaussianNoise(mean=0., std=1/50, p=0.25, keepdim=True),
            kornia.augmentation.RandomMotionBlur(9, 360., 1.0, p=0.025, keepdim=True)
        )
