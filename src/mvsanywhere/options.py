...
class Options:
    ...
    # if true, will save out depths and normals for use in regsplatfacto
    save_for_regsplatfacto: bool = False
    ...
    # flag for end to end script.
    scan_parent_directory: str = None
    scan_name: str = None
