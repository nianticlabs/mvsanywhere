...
from mvsanywhere.tools.tsdf import TSDF, TSDFFuser
from mvsanywhere.utils.generic_utils import reverse_imagenet_normalize
...
class Open3DFuser(DepthFuser):
    ...
    def __init__(
        ...
        self.volume = o3d.pipelines.integration.ScalableTSDFVolume(
            ...
            sdf_trunc=truncation * float(voxel_size) / 100,
    ...
    def fuse_frames(
        ...
        cam_T_world_b44,
        color_b3hw,
        apply_reverse_imagenet_normalize=True,
    ):
        ...
        if self.fuse_color:
            ...
            if apply_reverse_imagenet_normalize:
...
class CustomOpen3dFuser(Open3DFuser):
    ...
    def fuse_frames(
        ...
        for batch_index in range(depths_b1hw.shape[0]):
            ...
            # If no depth within max_fusion_depth, skip frame
            if depth_pred_hw.min() > self.max_fusion_depth:
                continue
    ...
    def get_mesh(
        ...
        mesh = self.volume.extract_triangle_mesh(weight_threshold=self.weight_threshold)
