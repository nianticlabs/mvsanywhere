...
marching_cubes_impl = load(
    name="ext",
    sources=[
        "src/mvsanywhere/tools/marching_cubes/ext.cpp",
        "src/mvsanywhere/tools/marching_cubes/marching_cubes_cpu.cpp",
        "src/mvsanywhere/tools/marching_cubes/marching_cubes.cu",
    ],
    verbose=True,
)
